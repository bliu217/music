      ...
      >
        <div className="">
          ...
          <a href="#notes">
            <img
              src={whole}
              className="absolute top-[117px] left-[180px] z-0 h-[28px] transition-transform duration-300 transform hover:scale-125"
            />
          </a>
          ...
          <a href="#notes">
            <img
              src={half}
              className="absolute top-[70px] left-[220px] z-0 h-[75px] transition-transform duration-300 transform hover:scale-110"
            />
            <img
              src={half}
              className="absolute top-[70px] left-[270px] z-0 h-[75px] transition-transform duration-300 transform hover:scale-110"
            />
          </a>
          ...
          <a href="#notes2">
            <img
              src={quarter}
              className="absolute top-[68px] left-[330px] z-0 h-[75px] transition-transform duration-300 transform hover:scale-110"
            />
            <img
              src={quarter}
              className="absolute top-[68px] left-[380px] z-0 h-[75px] transition-transform duration-300 transform hover:scale-110"
            />
          </a>
          ...
          <a href="#notes2">
            <img
              src={eight}
              className="absolute top-[68px] left-[445px] z-0 h-[75px] transition-transform duration-300 transform hover:scale-105"
            />
          </a>
