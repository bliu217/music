  ...
  return (
    ...
    <div class="relative flex items-center mx-40 my-20 z-1">
      <div>
            ...
            <h2 class= "text-4xl italic"> Music theory made easy</h2>
            ...
            <Button className="bg-bblue text-white font-outfit mb-5 mt-10 px-6 py-7 text-lg hover:bg-blue-600"> GET STARTED</Button>
          </div>
